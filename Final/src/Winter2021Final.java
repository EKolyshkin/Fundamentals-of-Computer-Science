...
public class Winter2021Final {
	...
	public static void main(String[] args) {
		...
		SortedLinkedList<Integer> init = new SortedLinkedList<Integer>(-5,42,42);
		SortedLinkedList<Integer> init2 = new SortedLinkedList<Integer>(0,0,0);
		SortedLinkedList<Integer> empty = new SortedLinkedList<Integer>();


		// 1. count data occurrences
		System.out.println("#1 initial: " + init); 
		System.out.println("count 42's = " + init.countData(42)); // 2
		System.out.println("count -5's = " + init.countData(-5)); // 1
		System.out.println("count 0's = " + init2.countData(0)); // 3
		System.out.println("count empty = " + empty.countData(1)); // 0
		...
		System.out.println(init.backwards()); // [-5]
