...
public class Post {
	...
	public static void main(String[] args) {
		...
		while (handle.hasNext()) { // loop is Big-O  O(N)
			System.out.println("next check: " + handle.next());
		}
		System.out.println("empty check: " + bag18.empty());
		System.out.println("push check: " + bag18.push(42));
		System.out.println("pop check: " + bag18.pop());
		System.out.println("peek check: " + bag18.peek());
